-- Criar tabela de discursos públicos (esboços S-99)
...
CREATE INDEX IF NOT EXISTS idx_discursos_numero ON discursos(numero);

-- Insert dos 194 discursos do S-99
INSERT INTO discursos (numero, titulo) VALUES
