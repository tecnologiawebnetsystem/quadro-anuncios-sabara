...
import { PrintRoteiroPresidente } from "@/components/impressao/print-layouts"
...
export default function ImpressaoRoteiroPresidentePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="print:hidden sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold">Roteiro do Presidente</h1>
              <p className="text-xs text-muted-foreground">Reunião de quinta-feira — com espaço para anotações</p>
            </div>
          </div>
        ...
        <PrintActionButtons
          printRef={printRef}
          documentTitle={`Roteiro do Presidente — ${nomesMes} ${anoAtual}`}
          colorScheme="green"
        />
      </div>
      ...
      <div className="p-6 max-w-4xl mx-auto print:p-0 print:max-w-none">
        ...
        ) : semanas.filter(s => !s.sem_reuniao).length === 0 ? (
